#ifndef SIMG4COMPONENTS_G4SAVETRACKERHITSWITHTRACKID_H
#define SIMG4COMPONENTS_G4SAVETRACKERHITSWITHTRACKID_H
...
/** @class SimG4SaveTrackerHitsWithDigiSmearing SimG4Components/src/SimG4SaveTrackerHitsWithDigiSmearing.h SimG4SaveTrackerHitsWithDigiSmearing.h
 *
...
class SimG4SaveTrackerHitsWithDigiSmearing: public GaudiTool, virtual public ISimG4SaveOutputTool {
public:
  explicit SimG4SaveTrackerHitsWithDigiSmearing(const std::string& aType, const std::string& aName, const IInterface* aParent);
  virtual ~SimG4SaveTrackerHitsWithDigiSmearing();
  /**  Initialize.
   *   @return status code
   */
...
private:
  ...
  DataHandle<fcc::PositionedTrackHitCollection> m_smearedTrackHits{"hits/smearedTrackerHits",
                                                                      Gaudi::DataHandle::Writer, this};
