#ifndef SIMG4COMPONENTS_G4MULTIPLEPARTICLEGENERATORTOOL_H
#define SIMG4COMPONENTS_G4MULTIPLEPARTICLEGENERATORTOOL_H
...
/** @class SimG4MultipleParticleGeneratorTool SimG4MultipleParticleGeneratorTool.h "SimG4MultipleParticleGeneratorTool.h"
*
...
class SimG4MultipleParticleGeneratorTool : public GaudiTool, virtual public ISimG4EventProviderTool {
public:
  /// Standard constructor
  SimG4MultipleParticleGeneratorTool(const std::string& type, const std::string& name, const IInterface* parent);

  virtual StatusCode initialize() final;

  /// Destructor
  virtual ~SimG4MultipleParticleGeneratorTool();
...
private:
  Gaudi::Property<std::vector<int>> m_puValues{this, "pileUpValueList", {1}, "List with PileUpValues "};
  int m_puCounter=0;
