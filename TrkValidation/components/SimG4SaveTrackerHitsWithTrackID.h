...
/** @class SimG4SaveTrackerHitsWithTrackID SimG4Components/src/SimG4SaveTrackerHitsWithTrackID.h SimG4SaveTrackerHitsWithTrackID.h
 *
...
class SimG4SaveTrackerHitsWithTrackID: public GaudiTool, virtual public ISimG4SaveOutputTool {
public:
  explicit SimG4SaveTrackerHitsWithTrackID(const std::string& aType, const std::string& aName, const IInterface* aParent);
  virtual ~SimG4SaveTrackerHitsWithTrackID();
  /**  Initialize.
   *   @return status code
   */
