#include "SimG4SaveTrackerHitsWithTrackID.h"
...
DECLARE_TOOL_FACTORY(SimG4SaveTrackerHitsWithTrackID)

SimG4SaveTrackerHitsWithTrackID::SimG4SaveTrackerHitsWithTrackID(const std::string& aType, const std::string& aName,
...
SimG4SaveTrackerHitsWithTrackID::~SimG4SaveTrackerHitsWithTrackID() {}

StatusCode SimG4SaveTrackerHitsWithTrackID::initialize() {
...
StatusCode SimG4SaveTrackerHitsWithTrackID::finalize() { return GaudiTool::finalize(); }

StatusCode SimG4SaveTrackerHitsWithTrackID::saveOutput(const G4Event& aEvent) {
