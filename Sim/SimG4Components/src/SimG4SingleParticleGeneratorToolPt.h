#ifndef SIMG4COMPONENTS_G4SINGLEPARTICLEGENERATORTOOLPT_H
#define SIMG4COMPONENTS_G4SINGLEPARTICLEGENERATORTOOLPT_H
...
/** @class SimG4SingleParticleGeneratorToolPt SimG4SingleParticleGeneratorToolPt.h "SimG4SingleParticleGeneratorToolPt.h"
*
...
class SimG4SingleParticleGeneratorToolPt : public GaudiTool, virtual public ISimG4EventProviderTool {
public:
  /// Standard constructor
  SimG4SingleParticleGeneratorToolPt(const std::string& type, const std::string& name, const IInterface* parent);

  virtual StatusCode initialize() final;

  /// Destructor
  virtual ~SimG4SingleParticleGeneratorToolPt();
