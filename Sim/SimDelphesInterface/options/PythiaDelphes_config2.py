...
gentool = PythiaInterface(Filename=pythiaConfFile, OutputLevel=messageLevelPythia)
...
hepmcgen = GenAlg("HepMCReader", SignalProvider=readertool)
hepmcgen.hepmc.Path = "hepmc"
...
############################################################
# Run Pythia + Delphes
ApplicationMgr( TopAlg = [ hepmcgen, hepmc_converter, delphessim, out ],
                EvtSel = 'NONE',
                EvtMax = nEvents,
                ExtSvc = [podioEvent])
